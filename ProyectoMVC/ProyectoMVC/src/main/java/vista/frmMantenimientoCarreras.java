...
public class frmMantenimientoCarreras extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("codigoFacultad");
        ...
        for (int i = 0; i < listaCarreras.size(); i++) {
            dato[0] = Integer.toString(listaCarreras.get(i).getCodigoCarrera());
            dato[1] = listaCarreras.get(i).getNombreCarrera();
            dato[2] = Integer.toString(listaCarreras.get(i).getCodigoFacultad());
    ...
    private void initComponents() {
        ...
        tablaCarreras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Carrera", "Nombre", "Codigo Facultad", "Estatus"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsCarreras carreras = new clsCarreras();
        carreras.setCodigoCarrera(Integer.parseInt(txtbuscado.getText()));
        registrosBorrados=carreras.setBorrarCarreras(carreras);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsCarreras carreras = new clsCarreras();
        carreras.setNombreCarrera(txtNombre.getText());
        carreras.setEstatusCarrera(txtEstatus.getText());
        carreras.setIngresarCarreras(carreras);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        carreras.setCodigoCarrera(Integer.parseInt(txtbuscado.getText()));        
        carreras = carreras.getBuscarInformacionCarrerasPorCodigo(carreras);
        System.out.println("Facultad retornada:" + carreras);        
        txtNombre.setText(carreras.getNombreCarrera());
        txtEstatus.setText(carreras.getEstatusCarrera());
...
//        // TODO add your handling code here:
        ...
        carreras.setNombreCarrera(txtNombre.getText());
        carreras.setEstatusCarrera(txtEstatus.getText());
        carreras.setModificarCarreras(carreras);
